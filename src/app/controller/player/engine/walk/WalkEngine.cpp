    ...
    {   
        ...
        {   
            ...
            {   
                ...
                }else if(params_.enableFlag == 1.0){
                    params_.enabledGain += 0.15;
                    if(params_.enabledGain > 1.0) params_.enabledGain = 1.0;  
                }else if(params_.enableFlag == 0.0){
                    params_.enabledGain -= 0.2;
                    if(params_.enabledGain < 0.0) params_.enabledGain = 0.0;  
                }
                tempParams.enabledGain = params_.enabledGain;

                if(tempParams.enabledGain != 1){
                    tempParams.stepGain = 0.0;
                }
                ...
                {   
                    ...
                    body_mat.set_p(Vector3d(0, 0, ROBOT->A()+ROBOT->B()));
                ...
                {   
                    while(ROBOT->conveyFeedbackParams.update_flag == false){
