...
class GroupSyncRead
{
 ...
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////////
  GroupSyncRead(std::shared_ptr<PortHandler> port, std::shared_ptr<PacketHandler> ph, uint16_t start_address, uint16_t data_length);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  std::shared_ptr<PacketHandler> getPacketHandler() { return ph_; }
