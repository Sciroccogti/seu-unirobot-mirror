...
class PacketHandler
{
 ...
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////////
  static std::shared_ptr<PacketHandler> getPacketHandler(float protocol_version = 2.0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int txPacket        (std::shared_ptr<PortHandler>  port, uint8_t *txpacket) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int rxPacket        (std::shared_ptr<PortHandler>  port, uint8_t *rxpacket) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int txRxPacket      (std::shared_ptr<PortHandler>  port, uint8_t *txpacket, uint8_t *rxpacket, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int ping            (std::shared_ptr<PortHandler>  port, uint8_t id, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int ping            (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t *model_number, uint8_t *error = 0) = 0;
  ...
  /// @return COMM_NOT_AVAILABLE
  ////////////////////////////////////////////////////////////////////////////////
  virtual int broadcastPing   (std::shared_ptr<PortHandler>  port, std::vector<uint8_t> &id_list) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int action          (std::shared_ptr<PortHandler>  port, uint8_t id) = 0;
  ...
  /// @return COMM_NOT_AVAILABLE
  ////////////////////////////////////////////////////////////////////////////////
  virtual int reboot          (std::shared_ptr<PortHandler>  port, uint8_t id, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int factoryReset    (std::shared_ptr<PortHandler>  port, uint8_t id, uint8_t option = 0, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int readTx          (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t length) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int readRx          (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t length, uint8_t *data, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int readTxRx        (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read1ByteTx     (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read1ByteRx     (std::shared_ptr<PortHandler>  port, uint8_t id, uint8_t *data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read1ByteTxRx   (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint8_t *data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::readTx()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read2ByteTx     (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address) = 0;
  ...
  /// @return communication results which come from PacketHandler::readRx()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read2ByteRx     (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t *data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read2ByteTxRx   (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t *data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::readTx()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read4ByteTx     (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address) = 0;
  ...
  /// @return communication results which come from PacketHandler::readRx()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read4ByteRx     (std::shared_ptr<PortHandler>  port, uint8_t id, uint32_t *data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int read4ByteTxRx   (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint32_t *data, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int writeTxOnly     (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int writeTxRx       (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error = 0) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int write1ByteTxOnly(std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint8_t data) = 0;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  virtual int write1ByteTxRx  (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint8_t data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::writeTxOnly()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int write2ByteTxOnly(std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t data) = 0;
  ...
  /// @return communication results which come from PacketHandler::writeTxRx()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int write2ByteTxRx  (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::writeTxOnly()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int write4ByteTxOnly(std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint32_t data) = 0;
  ...
  /// @return communication results which come from PacketHandler::writeTxRx()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int write4ByteTxRx  (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint32_t data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::txPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int regWriteTxOnly  (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int regWriteTxRx    (std::shared_ptr<PortHandler>  port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error = 0) = 0;
  ...
  /// @return communication results which come from PacketHandler::txPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int syncReadTx      (std::shared_ptr<PortHandler>  port, uint16_t start_address, uint16_t data_length, uint8_t *param, uint16_t param_length) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int syncWriteTxOnly (std::shared_ptr<PortHandler>  port, uint16_t start_address, uint16_t data_length, uint8_t *param, uint16_t param_length) = 0;
  ...
  /// @return communication results which come from PacketHandler::txPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int bulkReadTx      (std::shared_ptr<PortHandler>  port, uint8_t *param, uint16_t param_length) = 0;
  ...
  /// @return communication results which come from PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  virtual int bulkWriteTxOnly (std::shared_ptr<PortHandler>  port, uint8_t *param, uint16_t param_length) = 0;
};
