...
std::shared_ptr<Protocol2PacketHandler> Protocol2PacketHandler::instance_ = std::shared_ptr<Protocol2PacketHandler>(new Protocol2PacketHandler);
...
int Protocol2PacketHandler::txPacket(std::shared_ptr<PortHandler> port, uint8_t *txpacket)
{
...
int Protocol2PacketHandler::rxPacket(std::shared_ptr<PortHandler> port, uint8_t *rxpacket)
{
...
int Protocol2PacketHandler::txRxPacket(std::shared_ptr<PortHandler> port, uint8_t *txpacket, uint8_t *rxpacket, uint8_t *error)
{
  int result = COMM_TX_FAIL;
...
int Protocol2PacketHandler::ping(std::shared_ptr<PortHandler> port, uint8_t id, uint8_t *error)
{
  return ping(port, id, 0, error);
}

int Protocol2PacketHandler::ping(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t *model_number, uint8_t *error)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::broadcastPing(std::shared_ptr<PortHandler> port, std::vector<uint8_t> &id_list)
{
...
int Protocol2PacketHandler::action(std::shared_ptr<PortHandler> port, uint8_t id)
{
  uint8_t txpacket[10]        = {0};
...
int Protocol2PacketHandler::reboot(std::shared_ptr<PortHandler> port, uint8_t id, uint8_t *error)
{
  uint8_t txpacket[10]        = {0};
...
int Protocol2PacketHandler::factoryReset(std::shared_ptr<PortHandler> port, uint8_t id, uint8_t option, uint8_t *error)
{
...
int Protocol2PacketHandler::readTx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::readRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t length, uint8_t *data, uint8_t *error)
{
  int result                  = COMM_TX_FAIL;
...
int Protocol2PacketHandler::readTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error)
{
  int result                  = COMM_TX_FAIL;
...
int Protocol2PacketHandler::read1ByteTx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address)
{
  return readTx(port, id, address, 1);
}
int Protocol2PacketHandler::read1ByteRx(std::shared_ptr<PortHandler> port, uint8_t id, uint8_t *data, uint8_t *error)
{
...
int Protocol2PacketHandler::read1ByteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint8_t *data, uint8_t *error)
{
  uint8_t data_read[1] = {0};
...
int Protocol2PacketHandler::read2ByteTx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address)
{
  return readTx(port, id, address, 2);
}
int Protocol2PacketHandler::read2ByteRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t *data, uint8_t *error)
{
...
int Protocol2PacketHandler::read2ByteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t *data, uint8_t *error)
{
  uint8_t data_read[2] = {0};
...
int Protocol2PacketHandler::read4ByteTx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address)
{
  return readTx(port, id, address, 4);
}
int Protocol2PacketHandler::read4ByteRx(std::shared_ptr<PortHandler> port, uint8_t id, uint32_t *data, uint8_t *error)
{
...
int Protocol2PacketHandler::read4ByteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint32_t *data, uint8_t *error)
{
  uint8_t data_read[4] = {0};
...
int Protocol2PacketHandler::writeTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data)
{
  int result                  = COMM_TX_FAIL;
...
int Protocol2PacketHandler::writeTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error)
{
  int result                  = COMM_TX_FAIL;
...
int Protocol2PacketHandler::write1ByteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint8_t data)
{
  uint8_t data_write[1] = { data };
  return writeTxOnly(port, id, address, 1, data_write);
}
int Protocol2PacketHandler::write1ByteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint8_t data, uint8_t *error)
{
  uint8_t data_write[1] = { data };
  return writeTxRx(port, id, address, 1, data_write, error);
}

int Protocol2PacketHandler::write2ByteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t data)
{
  uint8_t data_write[2] = { DXL_LOBYTE(data), DXL_HIBYTE(data) };
  return writeTxOnly(port, id, address, 2, data_write);
}
int Protocol2PacketHandler::write2ByteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t data, uint8_t *error)
{
  uint8_t data_write[2] = { DXL_LOBYTE(data), DXL_HIBYTE(data) };
  return writeTxRx(port, id, address, 2, data_write, error);
}

int Protocol2PacketHandler::write4ByteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint32_t data)
{
...
int Protocol2PacketHandler::write4ByteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint32_t data, uint8_t *error)
{
  uint8_t data_write[4] = { DXL_LOBYTE(DXL_LOWORD(data)), DXL_HIBYTE(DXL_LOWORD(data)), DXL_LOBYTE(DXL_HIWORD(data)), DXL_HIBYTE(DXL_HIWORD(data)) };
  return writeTxRx(port, id, address, 4, data_write, error);
}

int Protocol2PacketHandler::regWriteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::regWriteTxRx(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::syncReadTx(std::shared_ptr<PortHandler> port, uint16_t start_address, uint16_t data_length, uint8_t *param, uint16_t param_length)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::syncWriteTxOnly(std::shared_ptr<PortHandler> port, uint16_t start_address, uint16_t data_length, uint8_t *param, uint16_t param_length)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::bulkReadTx(std::shared_ptr<PortHandler> port, uint8_t *param, uint16_t param_length)
{
  int result                 = COMM_TX_FAIL;
...
int Protocol2PacketHandler::bulkWriteTxOnly(std::shared_ptr<PortHandler> port, uint8_t *param, uint16_t param_length)
{
  int result                 = COMM_TX_FAIL;
