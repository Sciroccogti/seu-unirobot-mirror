...
{
 private:
  static std::shared_ptr<Protocol1PacketHandler> instance_;
 ...
 public:
  ...
  ////////////////////////////////////////////////////////////////////////////////
  static std::shared_ptr<Protocol1PacketHandler> getInstance() 
  {
      return instance_; 
  }
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int txPacket        (std::shared_ptr<PortHandler> port, uint8_t *txpacket);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int rxPacket        (std::shared_ptr<PortHandler> port, uint8_t *rxpacket);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int txRxPacket      (std::shared_ptr<PortHandler> port, uint8_t *txpacket, uint8_t *rxpacket, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int ping            (std::shared_ptr<PortHandler> port, uint8_t id, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int ping            (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t *model_number, uint8_t *error = 0);
  ...
  /// @return COMM_NOT_AVAILABLE
  ////////////////////////////////////////////////////////////////////////////////
  int broadcastPing   (std::shared_ptr<PortHandler> port, std::vector<uint8_t> &id_list);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int action          (std::shared_ptr<PortHandler> port, uint8_t id);
  ...
  /// @return COMM_NOT_AVAILABLE
  ////////////////////////////////////////////////////////////////////////////////
  int reboot          (std::shared_ptr<PortHandler> port, uint8_t id, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int factoryReset    (std::shared_ptr<PortHandler> port, uint8_t id, uint8_t option, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int readTx          (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int readRx          (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t length, uint8_t *data, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int readTxRx        (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int read1ByteTx     (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int read1ByteRx     (std::shared_ptr<PortHandler> port, uint8_t id, uint8_t *data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int read1ByteTxRx       (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint8_t *data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::readTx()
  ////////////////////////////////////////////////////////////////////////////////
  int read2ByteTx     (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address);
  ...
  /// @return communication results which come from Protocol1PacketHandler::readRx()
  ////////////////////////////////////////////////////////////////////////////////
  int read2ByteRx     (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t *data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int read2ByteTxRx       (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t *data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::readTx()
  ////////////////////////////////////////////////////////////////////////////////
  int read4ByteTx     (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address);
  ...
  /// @return communication results which come from Protocol1PacketHandler::readRx()
  ////////////////////////////////////////////////////////////////////////////////
  int read4ByteRx     (std::shared_ptr<PortHandler> port, uint8_t id, uint32_t *data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int read4ByteTxRx       (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint32_t *data, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int writeTxOnly     (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int writeTxRx           (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error = 0);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int write1ByteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint8_t data);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  int write1ByteTxRx      (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint8_t data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::writeTxOnly()
  ////////////////////////////////////////////////////////////////////////////////
  int write2ByteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t data);
  ...
  /// @return communication results which come from Protocol1PacketHandler::writeTxRx()
  ////////////////////////////////////////////////////////////////////////////////
  int write2ByteTxRx      (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::writeTxOnly()
  ////////////////////////////////////////////////////////////////////////////////
  int write4ByteTxOnly(std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint32_t data);
  ...
  /// @return communication results which come from Protocol1PacketHandler::writeTxRx()
  ////////////////////////////////////////////////////////////////////////////////
  int write4ByteTxRx      (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint32_t data, uint8_t *error = 0);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int regWriteTxOnly  (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int regWriteTxRx        (std::shared_ptr<PortHandler> port, uint8_t id, uint16_t address, uint16_t length, uint8_t *data, uint8_t *error = 0);
  ...
  /// @return COMM_NOT_AVAILABLE
  ////////////////////////////////////////////////////////////////////////////////
  int syncReadTx      (std::shared_ptr<PortHandler> port, uint16_t start_address, uint16_t data_length, uint8_t *param, uint16_t param_length);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txRxPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int syncWriteTxOnly (std::shared_ptr<PortHandler> port, uint16_t start_address, uint16_t data_length, uint8_t *param, uint16_t param_length);
  ...
  /// @return communication results which come from Protocol1PacketHandler::txPacket()
  ////////////////////////////////////////////////////////////////////////////////
  int bulkReadTx      (std::shared_ptr<PortHandler> port, uint8_t *param, uint16_t param_length);
  ...
  /// @return COMM_NOT_AVAILABLE
  ////////////////////////////////////////////////////////////////////////////////
  int bulkWriteTxOnly (std::shared_ptr<PortHandler> port, uint8_t *param, uint16_t param_length);
};
