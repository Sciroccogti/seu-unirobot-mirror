...
local_layer parse_local(clist *options, size_params params)
{
...
layer parse_deconvolutional(clist *options, size_params params)
{
    int n = option_find_int(options, "filters", 1);
    int size = option_find_int(options, "size", 1);
    int stride = option_find_int(options, "stride", 1);
...
convolutional_layer parse_convolutional(clist *options, size_params params)
{
    int n = option_find_int(options, "filters", 1);
    int size = option_find_int(options, "size", 1);
    int stride = option_find_int(options, "stride", 1);
...
layer parse_crnn(clist *options, size_params params)
{
...
layer parse_rnn(clist *options, size_params params)
{
...
layer parse_gru(clist *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_lstm(clist *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_connected(clist *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_softmax(clist *options, size_params params)
{
    int groups = option_find_int_quiet(options, "groups", 1);
...
layer parse_yolo(clist *options, size_params params)
{
...
layer parse_iseg(clist *options, size_params params)
{
    int classes = option_find_int(options, "classes", 20);
...
layer parse_region(clist *options, size_params params)
{
...
detection_layer parse_detection(clist *options, size_params params)
{
...
cost_layer parse_cost(clist *options, size_params params)
{
...
crop_layer parse_crop(clist *options, size_params params)
{
...
layer parse_reorg(clist *options, size_params params)
{
    int stride = option_find_int(options, "stride", 1);
...
maxpool_layer parse_maxpool(clist *options, size_params params)
{
    int stride = option_find_int(options, "stride", 1);
...
avgpool_layer parse_avgpool(clist *options, size_params params)
{
    int batch, w, h, c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(clist *options, size_params params)
{
...
layer parse_normalization(clist *options, size_params params)
{
...
layer parse_batchnorm(clist *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(clist *options, size_params params, network *net)
{
...
layer parse_l2norm(clist *options, size_params params)
{
...
layer parse_logistic(clist *options, size_params params)
{
...
layer parse_activation(clist *options, size_params params)
{
    char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_upsample(clist *options, size_params params, network *net)
{
...
route_layer parse_route(clist *options, size_params params, network *net)
{
...
void parse_net_options(clist *options, network *net)
{
...
{
    clist *sections = read_cfg(filename);
