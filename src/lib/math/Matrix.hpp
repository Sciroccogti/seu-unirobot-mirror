...
namespace seumath
{
    ...
    public:
        ...
        //  | p_x, p_y, p_z, 1 | // position
        f_inline TMatrix<DATATYPE, 3, 3> &R()
        {
            return mR;
        }
        f_inline const TMatrix<DATATYPE, 3, 3> &R() const
        {
            return mR;
        }

        f_inline TVector<DATATYPE, 3> &n()
        {
            return mR[0];
        }
        f_inline TVector<DATATYPE, 3> &o()
        {
            return mR[1];
        }
        f_inline TVector<DATATYPE, 3> &a()
        {
            return mR[2];
        }
        f_inline TVector<DATATYPE, 3> &p()
        {
            return mP;
        }

        f_inline const TVector<DATATYPE, 3> &n() const
        {
            return mR[0];
        }
        f_inline const TVector<DATATYPE, 3> &o() const
        {
            return mR[1];
        }
        f_inline const TVector<DATATYPE, 3> &a() const
        {
            return mR[2];
        }
        f_inline const TVector<DATATYPE, 3> &p() const
        {
            return mP;
        }

        f_inline TVector<DATATYPE, 3> &right()
        {
            return mR[0];
        }
        f_inline TVector<DATATYPE, 3> &forward()
        {
            return mR[1];
        }
        f_inline TVector<DATATYPE, 3> &up()
        {
            return mR[2];
        }
        f_inline TVector<DATATYPE, 3> &pos()
        {
            return mP;
        }

        f_inline const TVector<DATATYPE, 3> &right() const
        {
            return mR[0];
        }
        f_inline const TVector<DATATYPE, 3> &forward() const
        {
            return mR[1];
        }
        f_inline const TVector<DATATYPE, 3> &up() const
        {
            return mR[2];
        }
        f_inline const TVector<DATATYPE, 3> &pos() const
        {
            return mP;
        }
...
// dump
    template <typename DATATYPE>
    std::ostream &operator<<(std::ostream &os, const seumath::TransMatrix<DATATYPE> &m)
    {
        os << m.n() << " 0\n" << m.o() << " 0\n" << m.a() << " 0\n" << m.p() << " 1";
        return os;
    }
...
// dump
    template <typename DATATYPE>
    std::istream &operator>>(std::istream &is, seumath::TransMatrix<DATATYPE> &m)
    {
        DATATYPE temp;
        is >> m.n().x() >> m.n().y() >> m.n().z() >> temp;
        is >> m.o().x() >> m.o().y() >> m.o().z() >> temp;
        is >> m.a().x() >> m.a().y() >> m.a().z() >> temp;
        is >> m.p().x() >> m.p().y() >> m.p().z() >> temp;
        return is;
    }
