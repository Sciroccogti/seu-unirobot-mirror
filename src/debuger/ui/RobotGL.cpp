...
void RobotGL::draw_3d_bone(bone_ptr b)
{
    ...
    float r_j = 0.02;
    float j_l = 0.04;
    glRotatef(b->cr_[0], 1.0f, 0.0f, 0.0f);
    glRotatef(b->cr_[1], 0.0f, 1.0f, 0.0f);
    glRotatef(b->cr_[2], 0.0f, 0.0f, 1.0f);
    glTranslatef(-b->cp_[0], -b->cp_[1], -b->cp_[2]);
...
void RobotGL::setUserView()
{
    ...
    gluLookAt(m_transX, m_transY, m_transZ, g_look[0],
              g_look[1], g_look[2],
              0.0, 0.0, 1.0);
}
